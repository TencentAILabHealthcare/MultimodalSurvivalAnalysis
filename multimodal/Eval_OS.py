...
def get_args(parser):
    parser.add_argument("--savedir", type=str, default="/data3/louwei/MedComm/codes/multimodal/haparameter/os")
...
if __name__ == '__main__':
    ...
    results_df = pd.DataFrame({
        ...
        'event':event,
        'time':time,
        'prediction': risk_score_normalized
    })
    ...
    def determine_best_cutoff(df, time_col, event_col, risk_col, thresholds=None):
        ...
        for threshold in thresholds:
            ...
            if len(high_risk) < 10 or len(low_risk) < 10:
                continue  # 跳过样本太少的情况
